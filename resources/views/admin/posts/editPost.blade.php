                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="fname" placeholder="First Name Here"
                                        ...
                                        <input type="hidden" class="form-control" id="id" placeholder="First Name Here"
                                ...
                                <div class="col-md-9">
                                    <div class="custom-file">
                                        ...
                                        <img id="preview" src="{{ asset('storage/' . $post->image) }}"
                                            alt="{{ $post->image }}" width="100" height="100" class="rounded-circle mt-2" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="cono1" class="col-md-3 control-label col-form-label">Note
                                    (Markdown):</label>
                                <div class="col-md-12">
